...
// routes/rsvp.$invitationId.tsx

import type * as T from "react-router/route-module"

import type { Info as Parent0 } from "../../+types/root.js"

type Module = typeof import("../rsvp.$invitationId.js")

export type Info = {
  parents: [Parent0],
  id: "routes/rsvp.$invitationId"
  file: "routes/rsvp.$invitationId.tsx"
  path: "rsvp/:invitationId"
  params: {"invitationId": string} & { [key: string]: string | undefined }
  module: Module
